...
{
    public class GetProductByIdDapperQueryHandler : IRequestHandler<GetProductByIdQuery, Product>
    {
        private readonly IProductRepository _productRepository;

        public GetProductByIdDapperQueryHandler(IProductRepository prodcutRepository)
        {
