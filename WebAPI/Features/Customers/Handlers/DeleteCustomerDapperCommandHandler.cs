...
{
    public class DeleteCustomerDapperCommandHandler : IRequestHandler<DeleteCustomerCommand, Unit>
    {
        private readonly ICustomerRepository _customerRepository;

        public DeleteCustomerDapperCommandHandler(ICustomerRepository customerRepository)
        {
